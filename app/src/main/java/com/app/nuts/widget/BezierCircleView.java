...
public class BezierCircleView extends View {
    ...
    private int mRadiusBig = 60, mRadiusSmall = (int) (mRadiusBig / 2f), mWidth, mHeight, mMimWidth = (int) (mRadiusSmall * 2 * 3);
    private float mFraction = 0, mFractionDegree = 0,mLength,mDistanceBezier;
